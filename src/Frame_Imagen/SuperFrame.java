...
public class SuperFrame extends javax.swing.JFrame {
        ...
        public void VerPlayers() {
                ...
                for (int i = 0; i < Monopolis.nPlayers; i++) {
                        sum = sum + "Jugador: " + Monopolis.jugadores.get(i).getNombre() + " Posición: "
                                        + Monopolis.jugadores.get(i).getPosicion() + " Dinero: "
                                        + Monopolis.jugadores.get(i).getCoins()
                                        + "\n";
                }
                Info1.setText(sum);
                if (Monopolis.nPlayers == 6) {
                        Info1.setText("Jugador: " + Monopolis.jugadores.get(a).getNombre() + " Posición: "
                                        + Monopolis.jugadores.get(a).getPosicion() + " Dinero: "
                                        + Monopolis.jugadores.get(a).getCoins());
                        Info2.setText("Jugador: " + Monopolis.jugadores.get(b).getNombre() + " Posición: "
                                        + Monopolis.jugadores.get(b).getPosicion() + " Dinero: "
                                        + Monopolis.jugadores.get(b).getCoins());
                        Info3.setText("Jugador: " + Monopolis.jugadores.get(c).getNombre() + " Posición: "
                                        + Monopolis.jugadores.get(c).getPosicion() + " Dinero: "
                                        + Monopolis.jugadores.get(c).getCoins());
                        Info4.setText("Jugador: " + Monopolis.jugadores.get(d).getNombre() + " Posición: "
                                        + Monopolis.jugadores.get(d).getPosicion() + " Dinero: "
                                        + Monopolis.jugadores.get(d).getCoins());
                        Info5.setText("Jugador: " + Monopolis.jugadores.get(e).getNombre() + " Posición: "
                                        + Monopolis.jugadores.get(e).getPosicion() + " Dinero: "
                                        + Monopolis.jugadores.get(e).getCoins());
                        Info6.setText("Jugador: " + Monopolis.jugadores.get(f).getNombre() + " Posición: "
                                        + Monopolis.jugadores.get(f).getPosicion() + " Dinero: "
                                        + Monopolis.jugadores.get(f).getCoins());
        ...
        public void MagicPower(Jugador j) {
                ...
                int movD1 = Monopolis.lanzarDado();
                int movD2 = Monopolis.lanzarDado();
                if (mov == true) {
                        ...
                        // System.out.println("Tamaño array jugadores=n jugadores
                        // "+Monopolis.jugadores.size());
                        ...
                        if (posActual + res > 39) {
                                ...
                                monopolis.Monopolis.procesarEventoCasilla(j);
                                if (movD1 == movD2) {
                                        j.setMov(true);
                                        MagicPower(j);
                                        contador++;
                        ...
                        if (movD1 == movD2) {
                                ...
                                int posActual = j.getPosicion();// Modificamos la posición de los jugadores (label) en
                                                                // el juego
        ...
        private void initComponents() {
                ...
                javax.swing.GroupLayout jInternalFrame4Layout = new javax.swing.GroupLayout(
                                jInternalFrame4.getContentPane());
                ...
                javax.swing.GroupLayout jInternalFrame5Layout = new javax.swing.GroupLayout(
                                jInternalFrame5.getContentPane());
                ...
                javax.swing.GroupLayout jInternalFrame6Layout = new javax.swing.GroupLayout(
                                jInternalFrame6.getContentPane());
                jInternalFrame6.getContentPane().setLayout(jInternalFrame6Layout);
                jInternalFrame6Layout.setHorizontalGroup(
                                jInternalFrame6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                                jInternalFrame6Layout.createSequentialGroup()
                                                                                .addGap(0, 0, Short.MAX_VALUE)
                                                                                .addComponent(F5)));
                ...
                javax.swing.GroupLayout jInternalFrame7Layout = new javax.swing.GroupLayout(
                                jInternalFrame7.getContentPane());
        ...
        private void DadosActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_DadosActionPerformed
                ...
                if (money < 0) {
                        ...
                        if (monopolis.Monopolis.nPlayers == 1) {
                                ...
                                for (int i = 0; i < Monopolis.nPlayers; i++) {
                                        if (Monopolis.jugadores.get(i).getCoins() < 0) {
                                                ...
                                                for (int z = 0; z < 40; z++) {
                                                        if (Monopolis.proBanco.get(z).getPropietario()
                                                                        .compareTo(delete) == 0) {
                        ...
                        Monopolis.mostrarInformacionJugadores();// para ver cómo está el status de los jugadores
                }
